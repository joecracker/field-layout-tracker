      ...
      <main id="main-area">
        <div id="toolbar">
          ...
          <div className="toolbar-right">
            ...
            <span id="build-stamp" style={{ fontSize: '9px', opacity: 0.4, marginLeft: '6px' }} title="Build marker — bumps every push, confirms new code is live">build-2026-09-01-a</span>
          </div>
        </div>
